...
namespace ouroboros
{
   namespace detail
   {
      ...
      group<var_field> build_tree()
      {
         ...
         result.add(new base_string("A string", "A string for use in the program.", "hello", "", 10, {0, 10}));

         group<var_field> *group1 = new group<var_field>("Group 1", "This is Group 1.");
         group1.add(new base_string("A string inside group 1", "A string for use in the program.", "hello", "", 10, {0, 10}));

         group<var_field> *group2 = new group<var_field>("Group 2", "This is Group 2.");
         group2.add(new base_string("A string inside group 2", "A string for use in the program.", "hello", "", 10, {0, 10}));
